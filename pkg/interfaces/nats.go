...
type NATSClient interface {
	// Publishing
	PublishBatch(ctx context.Context, subjectFunc func(*models.Event) string, events []*models.Event) error
	// Consumer management
	...
	ListMessages(ctx context.Context, status models.MessageStatus, limit int, page int, topic string, partition string) ([]*NATSMessageItem, uint64, error)

...
func (n *workerTestNATS) PublishBatch(context.Context, func(*models.Event) string, []*models.Event) error {
	return nil
}
func (n *workerTestNATS) CreateOrUpdateConsumer(context.Context, string, []string) (jetstream.Consumer, error) {
	return nil, nil
}
func (n *workerTestNATS) MoveToDLQ(context.Context, jetstream.Msg, interfaces.DLQMoveOptions) error {
	n.dlqMoves++
	return nil
}
func (n *workerTestNATS) ReprocessDLQ(context.Context) (int, error) { return 0, nil }
func (n *workerTestNATS) ListMessages(context.Context, models.MessageStatus, int, int, string, string) ([]*interfaces.NATSMessageItem, uint64, error) {
	return nil, 0, nil
}
func (n *workerTestNATS) ListDLQMessages(context.Context, int, int) ([]*interfaces.NATSMessageItem, uint64, error) {
	return nil, 0, nil
}
...
func (n *workerTestNATS) ListConsumers(context.Context, int, int) ([]interfaces.NATSConsumerSummary, uint64, error) {
	return nil, 0, nil
}

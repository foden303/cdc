...
func NewMetricsService(store interfaces.Store, flowManager interfaces.FlowManager) *MetricsService {
...
func addFlowStats(stats map[string]*response.ComponentStats, componentID string, flowStats *interfaces.FlowStats) {

...
func (c *Client) MoveToDLQ(ctx context.Context, msg jetstream.Msg, opts interfaces.DLQMoveOptions) error {
...
func buildDLQEnvelope(msg jetstream.Msg, opts interfaces.DLQMoveOptions) (DLQEnvelope, error) {

...
func protoToSourceConfig(pb *cdcpb.SourceConfig) *ports.SourceConfig {
	if pb == nil {
		return nil
	}
...
func sourceConfigToProto(cfg *ports.SourceConfig) *cdcpb.SourceConfig {
	if cfg == nil {
		return nil
	}
...
func protoToSinkConfig(pb *cdcpb.SinkConfig) *ports.SinkConfig {
	if pb == nil {
		return nil
	}
...
func sinkConfigToProto(cfg *ports.SinkConfig) *cdcpb.SinkConfig {
	if cfg == nil {
		return nil
	}
	pb := &cdcpb.SinkConfig{
...
func flowConfigToProto(cfg *ports.FlowConfig) *cdcpb.FlowConfig {
	if cfg == nil {
		return nil
	}
	pb := &cdcpb.FlowConfig{
...
func flowStatusToProto(s ports.FlowStatus) cdcpb.FlowStatus {
	switch s {

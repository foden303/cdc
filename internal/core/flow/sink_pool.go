...
func NewSinkPoolManager(registry ports.Registry, store ports.Store) *SinkPoolManager {
...
func (m *SinkPoolManager) Acquire(ctx context.Context, sinkID string) (ports.Sink, error) {
	m.mu.Lock()
	defer m.mu.Unlock()

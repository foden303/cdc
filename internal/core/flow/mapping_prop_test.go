...
func TestProperty_MappingEnabledRename(t *testing.T) {
	rapid.Check(t, func(t *rapid.T) {
		...
		mappings := []ports.ColumnMapping{{SourceColumn: srcCol, SinkColumn: sinkCol, Enabled: true}}
...
func TestProperty_MappingDisabledExclude(t *testing.T) {
	rapid.Check(t, func(t *rapid.T) {
		...
		mappings := []ports.ColumnMapping{{SourceColumn: srcCol, SinkColumn: srcCol, Enabled: false}}
...
func TestProperty_MappingUnmappedPassthrough(t *testing.T) {
	rapid.Check(t, func(t *rapid.T) {
		...
		mappings := []ports.ColumnMapping{{SourceColumn: mappedCol, SinkColumn: "renamed", Enabled: true}}
...
func TestProperty_AutoGenerateCaseInsensitive(t *testing.T) {
	rapid.Check(t, func(t *rapid.T) {
		...
		sourceColumns := []ports.ColumnInfo{{Name: colName, Type: "text"}}
		sinkColumns := []ports.ColumnInfo{{Name: strings.ToUpper(colName), Type: "text"}}
